## Discovery Rect js footer component

Application serves test page that contains footer.

Footer is data data driven (please see `FooterData`). Footer contains simple state machine to transition between valid states.
...
## Comment
- I configured eslint, extended airbnb rules
- Fonts are served from local server, in production appliction should use CDN links, so users don't experience delays and / or default fonts instead of desired ones, additionally we can decrease app server load.
